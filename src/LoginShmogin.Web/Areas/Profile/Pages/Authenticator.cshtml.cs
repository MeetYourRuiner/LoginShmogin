...
namespace LoginShmogin.Web.Areas.Profile.Pages
{
    public class AuthenticatorModel : PageModel
    {
        ...
        public AuthenticatorModel(ICurrentUserService currentUserService, IAuthenticatorService authenticatorService, IIdentityService identityService, UrlEncoder urlEncoder)
        {
